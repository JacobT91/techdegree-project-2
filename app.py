        ...
        if menu_opt >= 3:
            ...
            while True:
                ...
                if menu_opt > len(teams):
                    print('\nThat is not a valid option. Please try agian...\n')
                    continue
                ...
                if menu_opt <= len(teams):
                    ...
                    for num in range(0, len(input_team['players'])):
                        ...
                        team_heights.append(input_team['players'][num]['height'])
                        team_guard += input_team['players'][num]['guardians']
                        
                        if input_team['players'][num]['experience'] == bool('T'):
                            team_exper += 1

                        elif input_team['players'][num]['experience'] == bool():
                            team_inexper += 1
                    ...
                    print('Average height: {}\n'.format(round(sum(team_heights)/ len(team_heights), 1)))
